...
const COLORS = {primary: '#465c62', white: '#fff'};
...
const slides = [
  ...
  },
  {
    ...
    subtitle: 'Participate in a project of a company by applying through our job application',
  },
];
            ...
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity
                ...
                style={[
                  styles.btn,
                  {
                    borderColor: theme.colors.black, //FOR THE SKIP BOTTUN
                    borderWidth: 1,
                    backgroundColor: theme.colors.black, //IT WAS 'TRANSPARENT' BEFORE
                  },
                ]}
                onPress={skip}>
                <Text
